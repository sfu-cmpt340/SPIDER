...
def main():
    ...
    y_predicted = gpc.predict(X_test)
    ...
    # Conclusion
    print("This method has 91% accuracy on normal, 75% on Suspect, 79% on pathological.\n The accuracy is better than the previous one but it takes way longer time.")
